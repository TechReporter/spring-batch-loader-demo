...
public class PatientEntity implements Serializable {
	...
	public String toString() {
		return "PatientEntity [id=" + id + ", sourceId=" + sourceId + ", firstName=" + firstName + ", middleInitial="
				+ middleInitial + ", lastName=" + lastName + ", emailAddress=" + emailAddress + ", phoneNumber="
				+ phoneNumber + ", street=" + street + ", city=" + city + ", state=" + state + ", zipCode=" + zipCode
